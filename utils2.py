...
bot.setBotPredicate("master","Yash Varshney")
bot.setBotPredicate("name","Yash's trained Bot")
...
bot.setBotPredicate("birthday","U Should know. U are my mother. ha ha ha")
...
def fetch_repl(query, sender_id):
	"""
